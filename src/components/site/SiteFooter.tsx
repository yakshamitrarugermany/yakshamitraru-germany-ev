import logo from "@/assets/yakshamitraru-logo.jpeg.asset.json";
    ...
    <footer className="bg-forest-deep text-cream border-t border-cream/10">
      <div className="container-page py-16 md:py-20 grid grid-cols-1 md:grid-cols-12 gap-10">
        <div className="md:col-span-5">
          <div className="flex items-center gap-3">
            <span className="relative grid place-items-center h-11 w-11 rounded-full bg-forest overflow-hidden">
              <Image src={logo.url} alt="" fill className="object-cover" />
            </span>
            <div className="leading-tight">
              <div className="font-serif text-lg">Yakshamitraru</div>
              <div className="eyebrow text-cream/60 text-[10px]">Germany e.V.</div>
            </div>
          </div>
        ...
        <div className="md:col-span-3">
          ...
          <ul className="mt-5 space-y-3 text-sm text-cream/80">
            <li><Link href="/#mission" className="hover:text-saffron transition-colors">Tradition</Link></li>
            <li><Link href="/events" className="hover:text-saffron transition-colors">Events</Link></li>
            <li><Link href="/artists" className="hover:text-saffron transition-colors">Artists</Link></li>
            <li><Link href="/gallery" className="hover:text-saffron transition-colors">Gallery</Link></li>
            <li><Link href="/contact#booking" className="hover:text-saffron transition-colors">Book a performance</Link></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-4">
          ...
          <ul className="mt-5 space-y-3 text-sm text-cream/80">
            <li>
              <a href="mailto:info@yakshamitraru.de" className="hover:text-saffron">
      ...
      <div className="border-t border-cream/10">
        <div className="container-page py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-cream/50">
          <span>© {new Date().getFullYear()} Yakshamitraru Germany e.V. All rights reserved.</span>
